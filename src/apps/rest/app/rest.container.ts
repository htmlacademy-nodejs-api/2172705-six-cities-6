...
export const createRESTAppContainer = () => {
  ...
  container.bind<RESTApp>(EComponentInterface.IRESTApp).to(RESTApp).inSingletonScope();
  container.bind<ILogger>(EComponentInterface.ILogger).to(PinoLogger).inSingletonScope();
